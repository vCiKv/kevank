...
const linkTypes = {
  ...
  default: "inline-flex items-center rounded-lg cursor-pointer bg-primary px-6 py-3 font-semibold text-white transition-all shadow-link cursor-pointer group gap-3",
