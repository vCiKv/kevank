...
export const SectionTitle = (props:SectionTitleProps)=>{
  return (
    <>
      <h1 className={twJoin("text-primary mt-3 mb-1 text-6xl font-black -tracking-wider",props.center?"text-center":"")}>{props.title}</h1>
...
export const Heading = (props:SectionTitleProps)=>{
  return (
    <>
      <h2 className={twJoin("mb-1 text-4xl font-extrabold -tracking-wide",props.center?"text-center":"")}>{props.title}</h2>
